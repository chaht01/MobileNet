...
tmux send-keys -t 1 "python main.py --exp m_RMS_1e-2 --arch MobileNet --lr 0.01 --optimizer RMSProp --width_mult 1.0  --gpu 0" ENTER
tmux send-keys -t 2 "python main.py --exp m_RMS_1e-2 --arch MobileNet --lr 0.01 --optimizer RMSProp --width_mult 0.75 --gpu 1" ENTER
tmux send-keys -t 3 "python main.py --exp m_RMS_1e-2 --arch MobileNet --lr 0.01 --optimizer RMSProp --width_mult 0.5 --gpu 1" ENTER
