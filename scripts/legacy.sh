...
tmux new-session -d -s 9
tmux new-session -d -s 10
tmux new-session -d -s 11
tmux new-session -d -s 12
tmux new-session -d -s 13
tmux new-session -d -s 14
tmux new-session -d -s 15
tmux new-session -d -s 16
tmux new-session -d -s 17
tmux new-session -d -s 18
tmux new-session -d -s 19
tmux new-session -d -s 20
tmux new-session -d -s 21
tmux new-session -d -s 22
tmux new-session -d -s 23
tmux new-session -d -s 24
tmux new-session -d -s 25
tmux new-session -d -s 26
...
## width compare
tmux send-keys -t 24 "python ../main.py\
...
tmux send-keys -t 25 "python ../main.py\
...
## shallow
tmux send-keys -t 26 "python ../main.py\
